// ;!function(){
  ...
  ,laydate = {
    ...
    ,ready: function(fn){
      ...
      ,path = (isLayui ? 'modules/laydate/' : '/') + 'laydate.css?v='+ laydate.v + ver;
  ...
  */
  ...
  Class.prototype.render = function(){
    ...
    lay(divFooter).html(function(){
      ...
      if(options.type === 'datetime'){
        btns.push('<span lay-type="datetime" class="laydate-btns-time">'+ lang.timeTips +'</span>');
      }
  ...
  Class.prototype.checkDate = function(fn){
    ...
    ,thisMaxDate, error, elem = that.bindElem || options.elem[0], valType = that.isInput(elem) ? 'val' : 'html'
  ...
  Class.prototype.stampRange = function(){
    ...
    lay.each(tds, function(i, item){
      ...
      lay(item).removeClass(ELEM_SELECTED + ' ' + THIS + ' ' +'startRange' + ' ' + 'endRange allRange')
  ...
  Class.prototype.choose = function(td){
    ...
    if(options.range){
      ...
      if(that.endState){ //重新选择
        ...
        tds.removeClass(THIS + ' ' + ELEM_SELECTED + ' ' + 'startRange');
        td.addClass(THIS + ' startRange');
      } else if(that.startState){ //选中截止
        td.addClass(THIS + ' endRange');
        ...
        setTimeout(() => {
          $(that.elem).find('.laydate-btns-confirm').trigger('click')
        }, 100)
      } else { //选中开始
        td.addClass(THIS + ' startRange');
        setDateTime(); 
